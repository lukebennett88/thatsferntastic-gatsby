          ...
          <nav className="flex-1 px-2 bg-white">
            {navigation.map((navItem) => (
              <Link
                ...
                className="flex items-center px-2 py-2 mt-1 text-sm font-medium leading-5 text-gray-600 transition duration-150 ease-in-out rounded-md group first:mt-0 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-100"
              >
